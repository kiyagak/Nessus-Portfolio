...
- Run the command:
		...
		sudo dpkg -i Nessus-10.9.4-debian10_amd64.deb.deb

- This installs Nessus on Kali Linux.
- Start the Nessus service:
- Run the command to start the Nessus daemon:
...
- Configure Nessus through the web interface:
